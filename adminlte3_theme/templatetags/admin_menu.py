    ...
    def render(self, context, menus=None):
        ...
        if len(menus) <= 0:
            ...
            if(request.path == reverse('admin:index')):
                r = '<li class="nav-item"><a href="' + reverse('admin:index') + '" class="nav-link active"><i class="nav-icon fas fa-tachometer-alt"></i> <p>Admin</p></a></li>'
            else:
                r = '<li class="nav-item"><a href="' + reverse('admin:index') + '" class="nav-link"><i class="nav-icon fas fa-tachometer-alt"></i> <p>Admin</p></a></li>'
